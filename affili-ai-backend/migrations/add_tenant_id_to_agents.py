"""
Migration script to add tenant_id to agents table.
...
def migrate():
    ...
    try:
        ...
        if "tenant_id" in columns:
            print("✓ Column 'tenant_id' already exists in agents table. Skipping migration.")
            return
        ...
        print("Setting default tenant for existing agents...")
        cursor.execute(f"""
            UPDATE agents 
