...
def test_db_url():
    ...
    # Force settings to use this URL to ensure consistency across the app
...
def engine(test_db_url):
    ...
    # Create all tables
    print("DEBUG: Executing Base.metadata.create_all...")
    try:
        Base.metadata.create_all(bind=engine)
        print("DEBUG: create_all successful.")
    except Exception as e:
        print(f"DEBUG: create_all FAILED: {e}")
        import traceback
        traceback.print_exc()
        raise e
